...
set -gx VIRTUAL_ENV 'D:\_Neoversity\HWs\PythonPro\goit-pythonweb-hw-01-1\.venv'
...
if test -n goit-pythonweb-hw-01-1-py3.12
    set -gx VIRTUAL_ENV_PROMPT goit-pythonweb-hw-01-1-py3.12
else
